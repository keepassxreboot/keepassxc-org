...
prevent secrets from remaining in memory after a database is locked. Combined with
the existing restrictions on memory access by non-administrators, this feature greatly
