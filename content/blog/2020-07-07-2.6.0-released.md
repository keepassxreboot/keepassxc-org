...
![2.6.0 Theme Comparison]({{< baseurl >}}blog/images/2.6.0_theme_comparison.png)

![2.6.0 Database View]({{< baseurl >}}blog/images/2.6.0_database_view.png)

![2.6.0 Entry Icons]({{< baseurl >}}blog/images/2.6.0_entry_icons.png)
