...
- <i class="fa-brands fa-windows"></i> Windows:
  [<i class="fa-solid fa-download"></i> AMD64 (MSI)](https://github.com/keepassxreboot/keepassxc/releases/download/2.8.0-beta1/KeePassXC-2.8.0-beta1-x64.msi),
  ...
  [<i class="fa-solid fa-download"></i> AMD64 (Portable)](https://github.com/keepassxreboot/keepassxc/releases/download/2.8.0-beta1/KeePassXC-2.8.0-beta1-x64.zip),
...
- <i class="fa-solid fa-code"></i> Source code: [<i class="fa-solid fa-download"></i> TAR.XZ](https://github.com/keepassxreboot/keepassxc/releases/download/2.8.0-beta1/keepassxc-v2.8.0-beta1-src.tar.xz)
