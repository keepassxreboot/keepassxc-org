...
date: 2025-11-24T01:10:00+01:00
category: "Releases"
...
The CSPN security Visa certifies that the product was tested to comply with ANSSI first-level security standards. The certification is recognised by French authorities and internationally by the German Federal Office for Information Security (BSI). The certificate and more information about the CSPN programme can be found on the [ANSSI website](https://cyber.gouv.fr/produits-certifies/keepassxc-version-279). We have also created a dedicated page [listing all previous security reviews]({{< baseurl >}}audits/) of KeePassXC where you can download the full technical audit report. We will keep the page updated with any future audits and certifications.
