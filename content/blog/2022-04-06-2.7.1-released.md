...
our [<i class="fa-brands fa-ubuntu"></i> Ubuntu PPA](https://launchpad.net/~phoerious/+archive/ubuntu/keepassxc/), and
[{{< snapcraft-icon >}} Snapcraft](https://snapcraft.io/keepassxc/) (Flatpak TBA).
